...
RULES = [
    ...
    Rule(
        ...
        r"автоматическ|noreply@jira|\[INFO\].*healthcheck|плановый",
    ...
    Rule(
        ...
        r"инцидент|авария|недоступ|баг|упал|не функциониру|проблем",
    ...
    Rule(
        ...
        r"приложени|лицензи|софт|драйвер|перезагруз",
